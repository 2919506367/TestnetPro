            ...
            <div className="p-4 border-b border-white/10 flex-shrink-0">
              ...
              <button onClick={() => { setShowUserProfile(true); closeComments(); }} className="flex items-center gap-2 mb-3 hover:bg-white/5 rounded-lg p-1.5 -ml-1.5 transition-all w-full text-left">
                <div className="w-8 h-8 rounded-full bg-white/10 flex-shrink-0 overflow-hidden">
                  {activeVideo.authorFace ? <BiliImage rawUrl={activeVideo.authorFace} alt="" className="w-full h-full object-cover" /> : <User className="w-4 h-4 m-2 text-white/40" />}
                </div>
  ...
  return (
    <div className="snap-start h-full w-full relative bg-black shrink-0 flex items-center justify-center">
      {isActive ? (
        ...
        <>
          <BiliImage rawUrl={video.cover} alt={video.title} className="absolute inset-0 w-full h-full object-cover" loading="lazy" />
  ...
  if (!resolved) {
    return (
      <div className="fixed inset-0 z-40 pointer-events-none">
        <BiliImage rawUrl={video.cover} alt="" className="absolute inset-0 w-full h-full object-cover opacity-60" />
    ...
    <div className="fixed inset-0 z-40 pointer-events-none">
      ...
      {status === "loading" && (
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <BiliImage rawUrl={video.cover} alt="" className="absolute inset-0 w-full h-full object-cover opacity-30" />
          <div className="absolute inset-0 bg-black/40" />
          ...
          <div className="space-y-2">
            ...
            {results.results.map((item, i) => (
              type === "video" ? (
                ...
                >
                  <BiliImage rawUrl={item.cover} alt="" className="w-28 h-20 object-cover rounded-lg flex-shrink-0" loading="lazy" />
                ...
                >
                  <BiliImage rawUrl={item.face} alt="" className="w-12 h-12 rounded-full flex-shrink-0" />
                  <div className="flex-1 min-w-0">
