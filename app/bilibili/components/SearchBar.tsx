                  ...
                  type === "video" ? (
                    ...
                    >
                      <div className="relative flex-shrink-0 w-28 h-20 rounded-lg overflow-hidden bg-gray-800">
                        <BiliImage rawUrl={(item as SearchVideoResult).cover} alt="" className="w-full h-full object-cover" loading="lazy" />
                    ...
                    <button
                      ...
                      className={`flex gap-3 p-2 rounded-xl ${hoverBg} transition-all w-full text-left`}
                    >
                      <BiliImage rawUrl={(item as SearchUserResult).face} alt="" className="w-10 h-10 rounded-full flex-shrink-0 bg-gray-300" />
